...
parser.add_argument('--img_path', type=str, default='data/test_img/20436312_1683447152.jpg', help='the path of the input image to network')
...
parser.add_argument('--encoder', type=str, default='weights/encoder.pth', help="path to encoder (to continue training)")
parser.add_argument('--decoder', type=str, default='weights/decoder.pth', help='path to decoder (to continue training)')
