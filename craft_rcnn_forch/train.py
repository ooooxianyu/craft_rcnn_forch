...
parser.add_argument('--train_list', default='data/train.txt', type=str, help='path to train dataset list file')
parser.add_argument('--eval_list', type=str, default='data/test.txt', help='path to evalation dataset list file')
...
parser.add_argument('--model', default='weights/', help='Where to store samples and models')
...
# load alphabet
with open('D:/AIstudyCode/craft_cnn_seq2seq_chorc/data/char_std_5990.txt', encoding="UTF-8") as f:
    data = f.readlines()
